<template>
  <div
    class="sm:col-start-2 fixed right-0 left-[240px] top-full grid justify-items-center max-h-0"
  >
    {{ showTwitterFlyout }}
    <div
      ...
      :class="{
        'opacity-0 pointer-events-none translate-y-12':
          !showTwitterFlyout || !store.enableTwitterFlyout,
      }"
    >
      <img
        src="https://github.com/idered.png"
        alt=""
        class="w-8 rounded-full"
      />

      <span class="text-slate-400 font-medium text-sm">
        Your first screenshot looks great <span class="ml-1"> 🎉</span> If you
        like this tool, follow me on Twitter for more!
      </span>
