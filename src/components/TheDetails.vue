...
<template>
  <OnClickOutside @trigger="isExpanded = false" class="grid overflow-hidden">
    <div class="sm:hidden" :style="{ height: '57px' }"></div>
    <div
      class="fixed z-10 inset-x-0 bottom-0 content-start border-t border-zinc-800 bg-zinc-900 transition-[height] sm:static sm:overflow-hidden sm:border-l sm:border-t-0 sm:transition-none pwa:sm:border-t pwa:sm:border-t-black pwa:sm:shadow-[inset_0_1px_0_rgb(39_39_42)] sm:grid sm:!h-auto"
      :style="{
    ...
    >
      <div
        ...
        class="max-h-[calc(30svh-48px)] sm:max-h-none grid overflow-auto"
      >
        <div class="grid gap-y-2 px-3 py-4">
          <!-- <div
            class="flex text-xs font-semibold text-center bg-zinc-950 py-1 px-1 rounded"
          >
            <div class="flex-1 bg-blue-700 rounded-sm py-1 text-white">
              Auto layout
            </div>
            <div class="flex-1 rounded-sm py-1 text-zinc-600">Freeform</div>
          </div> -->
          <div
          ...
          <hr class="border-y border-b-zinc-800 border-t-black -mx-3 my-1.5" />
      ...
      <hr
        class="border-y border-b-zinc-800 border-t-black -mx-3 hidden sm:block pwa:hidden"
      />
    ...
    >
      <ExportToPNGButton class="h-10" />
      <BaseButton
        class="group h-10 w-10 justify-center bg-slate-700 text-slate-500 hover:bg-slate-700/80 sm:hidden"
