...
<template>
  <div
    v-if="!preview"
    class="flex items-center justify-center px-2 pt-2 pwa:sm:border-t pwa:sm:border-t-slate-900 pwa:sm:shadow-[inset_0_1px_0_rgb(30_30_37)] overflow-hidden"
  >
    <div
      class="border border-slate-700 bg-slate-800 px-3 py-2 rounded-full overflow-auto"
    >
      ...
      >
        ...
        <BaseButton
          ...
          class="h-6 px-2 rounded-full hover:text-slate-100 whitespace-nowrap"
          :class="{
            'bg-slate-50 text-slate-900 hover:text-slate-900':
              store.editMode === 'add',
          }"
        ...
        <BaseButton
          ...
          "
          class="h-6 px-2 rounded-full enabled:hover:text-slate-100 disabled:opacity-50"
          :disabled="
