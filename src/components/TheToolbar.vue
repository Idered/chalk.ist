...
<template>
  <div
    v-if="!preview"
    class="flex items-center justify-between border-b border-slate-700 bg-slate-800 px-3 py-3 pwa:sm:border-t pwa:sm:border-t-slate-900 pwa:sm:shadow-[inset_0_1px_0_rgb(30_30_37)]"
  >
