<template>
  ...
  >
    <div
      class="aqua-spray p-8 grid overflow-hidden duration-500 justify-items-end transition"
      :class="{
        'opacity-0 scale-95': !editor || !editor.isReady,
      }"
      ref="frame"
    >
...
const editor =
  ref<{ editorRef: monaco.editor.IStandaloneCodeEditor; isReady: boolean }>();
...
<style>
.shadow-app {
  --shadow-elevation-low: 0px 0.6px 0.7px hsl(v-bind("theme.shadow") / 0.31),
    0px 0.9px 1px -1.2px hsl(v-bind("theme.shadow") / 0.33),
    0px 2.2px 2.5px -2.3px hsl(v-bind("theme.shadow") / 0.35);
  --shadow-elevation-medium: 0px 0.6px 0.7px hsl(v-bind("theme.shadow") / 0.33),
    0px 1.9px 2.2px -0.8px hsl(v-bind("theme.shadow") / 0.34),
    0px 4.7px 5.4px -1.5px hsl(v-bind("theme.shadow") / 0.35),
    0px 11.2px 12.9px -2.3px hsl(v-bind("theme.shadow") / 0.37);
  --shadow-elevation-high: 0px 0.6px 0.7px hsl(v-bind("theme.shadow") / 0.3),
