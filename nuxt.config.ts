...
export default defineNuxtConfig({
  ...
  modules: ["@nuxtjs/tailwindcss", "@pinia/nuxt", "unplugin-icons/nuxt", "@vite-pwa/nuxt", "@nuxt/scripts"],
  ...
  app: {
    head: {
      ...
      meta: [
        { name: 'description', content: 'Turn your source code into beautiful images' },
        { name: 'twitter:card', content: 'summary_large_image' },
        { name: 'twitter:title', content: 'Chalk.ist - Create beautiful images of your source code' },
        ...
        { name: 'twitter:description', content: 'Turn your source code into beautiful images' },
        { property: 'og:title', content: 'Chalk.ist - Create beautiful images of your source code' },
        { property: 'og:type', content: 'website' },
        { property: 'og:url', content: 'https://chalk.ist' },
        { property: 'og:image', content: 'https://chalk.ist/og-image.jpg' },
        { property: 'og:description', content: 'Turn your source code into beautiful images' }
      ],
      link: [
      ...
      bodyAttrs: {
        class: "font-inter text-slate-500 subpixel-antialiased selection:bg-blue-600/50 selection:text-white"
      }
    }
  },
